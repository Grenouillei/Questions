        ...
        <table class="table-fixed" style="color: black;width: 100%;">
            ...
            @foreach($levels as $level)
                ...
                <tr @if($i%2!=0) class="bg-gray-200" @endif>
                    ...
                    <td class="border px-4 py-2">{{$level->title}}</td>
                    <td class="border px-4 py-2">{{$level->alias}}</td>
                    <td class="border px-4 py-2">
                        ...
                        <form method="post" action="{{route('admin.levels.destroy',$level->id)}}" style="display: inline-block;margin-bottom: 0;">
                            @csrf
                            @method('DELETE')
